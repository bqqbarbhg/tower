...
object Matrix43 {
  ...
  def world(forward: Vector3, right: Vector3, up: Vector3, origin: Vector3 = Vector3.Zero): Matrix43 = {
    val r = new Matrix43()
    r.m11 = right.x
    r.m12 = right.y
    r.m13 = right.z
...
class Matrix43 {
  ...
  def inverse: Matrix43 = {
    ...
    r.m11 = (m23*m32 + m22*m33) * invDet
    r.m12 = (m13*m32 - m12*m33) * invDet
    r.m13 = (m13*m22 + m12*m23) * invDet
    r.m14 = (m14*m23*m32 - m13*m24*m32 - m14*m22*m33 + m12*m24*m33 + m13*m22*m34 - m12*m23*m34) * invDet
    r.m21 = (m23*m31 - m21*m33) * invDet
    r.m22 = (m13*m31 + m11*m33) * invDet
    r.m23 = (m13*m21 - m11*m23) * invDet
    r.m24 = (m13*m24*m31 - m14*m23*m31 + m14*m21*m33 - m11*m24*m33 - m13*m21*m34 + m11*m23*m34) * invDet
    r.m31 = (m22*m31 + m21*m32) * invDet
    r.m32 = (m12*m31 - m11*m32) * invDet
    r.m33 = (m12*m21 + m11*m22) * invDet
